...
import it.expleo.qmap.repository.CRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CResource {
    ...
    private static final String ENTITY_NAME = "sonarImporterC";
