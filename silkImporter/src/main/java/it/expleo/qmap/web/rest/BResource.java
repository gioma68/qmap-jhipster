...
import it.expleo.qmap.domain.B;
import it.expleo.qmap.repository.BRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BResource {
    ...
    private static final String ENTITY_NAME = "silkImporterB";
