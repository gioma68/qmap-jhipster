...
import it.expleo.qmap.repository.ARepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AResource {
    ...
    private static final String ENTITY_NAME = "silkImporterA";
