...
import it.expleo.qmap.repository.DRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.domain.D}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DResource {
    ...
    private static final String ENTITY_NAME = "webIinspectImporterD";
