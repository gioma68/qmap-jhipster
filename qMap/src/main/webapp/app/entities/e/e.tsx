  ...
  return (
    <div>
      <h2 id="e-heading" data-cy="EHeading">
        <Translate contentKey="qMapApp.e.home.title">ES</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> <Translate contentKey="qMapApp.e.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="qMapApp.e.home.createLabel">Create new E</Translate>
          </Link>
        </div>
      </h2>
        ...
        {eList && eList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="qMapApp.e.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="qMapApp.e.home.notFound">No ES found</Translate>
            </div>
          )
        )}
      </div>
