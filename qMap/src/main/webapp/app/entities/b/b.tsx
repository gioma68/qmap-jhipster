  ...
  return (
    <div>
      <h2 id="b-heading" data-cy="BHeading">
        <Translate contentKey="qMapApp.b.home.title">BS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> <Translate contentKey="qMapApp.b.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="qMapApp.b.home.createLabel">Create new B</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bList && bList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="qMapApp.b.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="qMapApp.b.a">A</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="qMapApp.b.home.notFound">No BS found</Translate>
            </div>
          )
        )}
      </div>
