package it.expleo.qmap.importer.sonarqb.web.rest;

import it.expleo.qmap.importer.sonarqb.domain.C;
import it.expleo.qmap.importer.sonarqb.repository.CRepository;
import it.expleo.qmap.importer.sonarqb.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link it.expleo.qmap.importer.sonarqb.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CResource {
    ...
    private static final String ENTITY_NAME = "qMapSonarQbImporterC";
