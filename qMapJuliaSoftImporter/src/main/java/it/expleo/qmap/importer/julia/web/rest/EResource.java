package it.expleo.qmap.importer.julia.web.rest;

import it.expleo.qmap.importer.julia.domain.E;
import it.expleo.qmap.importer.julia.repository.ERepository;
import it.expleo.qmap.importer.julia.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link it.expleo.qmap.importer.julia.domain.E}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EResource {
    ...
    private static final String ENTITY_NAME = "qMapJuliaSoftImporterE";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/es/{id}", consumes = "application/merge-patch+json")
