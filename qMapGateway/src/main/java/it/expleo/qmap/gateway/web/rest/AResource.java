...
import it.expleo.qmap.gateway.domain.A;
import it.expleo.qmap.gateway.repository.ARepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.gateway.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
