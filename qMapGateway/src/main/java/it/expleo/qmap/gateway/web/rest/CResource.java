...
import it.expleo.qmap.gateway.domain.C;
import it.expleo.qmap.gateway.repository.CRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.gateway.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
