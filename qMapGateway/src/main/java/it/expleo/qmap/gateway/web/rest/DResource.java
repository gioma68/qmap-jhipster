...
import it.expleo.qmap.gateway.domain.D;
import it.expleo.qmap.gateway.repository.DRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.gateway.domain.D}.
 */
@RestController
@RequestMapping("/api")
@Transactional
