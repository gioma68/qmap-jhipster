...
import it.expleo.qmap.gateway.domain.B;
import it.expleo.qmap.gateway.repository.BRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.gateway.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
