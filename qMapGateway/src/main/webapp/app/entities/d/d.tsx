  ...
  return (
    <div>
      <h2 id="d-heading" data-cy="DHeading">
        <Translate contentKey="qMapGatewayApp.d.home.title">DS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="qMapGatewayApp.d.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="qMapGatewayApp.d.home.createLabel">Create new D</Translate>
          </Link>
        </div>
      </h2>
        ...
        {dList && dList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="qMapGatewayApp.d.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="qMapGatewayApp.d.home.notFound">No DS found</Translate>
            </div>
          )
        )}
      </div>
