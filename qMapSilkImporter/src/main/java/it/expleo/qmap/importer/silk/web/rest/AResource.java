package it.expleo.qmap.importer.silk.web.rest;

import it.expleo.qmap.importer.silk.domain.A;
import it.expleo.qmap.importer.silk.repository.ARepository;
import it.expleo.qmap.importer.silk.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link it.expleo.qmap.importer.silk.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AResource {
    ...
    private static final String ENTITY_NAME = "qMapSilkImporterA";
