...
import it.expleo.qmap.importer.silk.repository.BRepository;
...
/**
 * REST controller for managing {@link it.expleo.qmap.importer.silk.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BResource {
    ...
    private static final String ENTITY_NAME = "qMapSilkImporterB";
